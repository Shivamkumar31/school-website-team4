      ...
      >
        {filteredTeachers.map((teacher, index) => (
          ...
          >
            ...
            />
            <h3 className="text-lg font-semibold text-purple-700">{teacher.name}</h3>
            <p className="text-sm text-gray-700"><strong>NIP:</strong> {teacher.nip}</p>
            <p className="text-sm text-gray-600"><strong>Pelajaran:</strong> {teacher.subject}</p>
          </motion.div>
        ))}
      </motion.div>
    </div>
