    ...
    <section className="mb-6">
      ...
      <ul className="list-disc ml-6">
        {materials.map((item, idx) => (
          <li key={idx}>
            <a href={item.file} className="text-blue-700 underline" download>{item.name}</a>
          </li>
        ))}
      </ul>
    </section>
